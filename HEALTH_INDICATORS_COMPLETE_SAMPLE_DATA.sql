-- ============================================================================
-- HEALTH INDICATORS SAMPLE DATA WITH SAMPLE RESIDENTS
-- ============================================================================
-- This script:
-- 1. First creates sample residents
-- 2. Then inserts health indicators linked to those residents
-- Ready to use with Supabase
-- ============================================================================

-- STEP 0: Insert Sample Residents (REQUIRED for foreign key constraints)
INSERT INTO public.residents 
(id, barangay, purok, full_name, birth_date, sex, contact_number, philhealth_no, created_by, created_at, updated_at)
VALUES
('650e8400-e29b-41d4-a716-446655440001'::uuid, 'Abella', '1', 'Maria Santos', '1965-03-15'::date, 'Female', '09171234567', 'PH-2024-001', 'f6306fad-40d1-4b8d-bb9e-5817242e059b'::uuid, NOW(), NOW()),
('650e8400-e29b-41d4-a716-446655440002'::uuid, 'Bagumbayan Norte', '2', 'Juan Cruz', '1972-07-22'::date, 'Male', '09281234567', 'PH-2024-002', 'f6306fad-40d1-4b8d-bb9e-5817242e059b'::uuid, NOW(), NOW()),
('650e8400-e29b-41d4-a716-446655440003'::uuid, 'Bagumbayan Sur', '3', 'Rosa Garcia', '1980-11-08'::date, 'Female', '09321234567', 'PH-2024-003', 'f6306fad-40d1-4b8d-bb9e-5817242e059b'::uuid, NOW(), NOW()),
('650e8400-e29b-41d4-a716-446655440004'::uuid, 'Calabanga', '4', 'Pedro Reyes', '1955-05-30'::date, 'Male', '09191234567', 'PH-2024-004', 'f6306fad-40d1-4b8d-bb9e-5817242e059b'::uuid, NOW(), NOW());
